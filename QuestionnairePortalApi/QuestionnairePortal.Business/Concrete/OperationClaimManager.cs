...
namespace Business.Concrete
{
    ...
    public class OperationClaimManager : IOperationClaimService
    {
        ...
        public IListDataResult<OperationClaim> GetOperationClaims() => new SuccessListDataResult<OperationClaim>(OperationClaimDal.GetAll());

        public ISingleDataResult<OperationClaim> GetByOperationClaimId(int operationClaimId) => new SuccessSingleDataResult<OperationClaim>(OperationClaimDal.Get(operationClaim => operationClaim.Id == operationClaimId));
